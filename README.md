...
## Update v1.2.0 重构音频裁剪和PCM数据回调逻辑， 使调用更简单。

## Usage:

### Gradle: [ ![Download](https://api.bintray.com/packages/ywl5320/maven/wlmusic/images/download.svg?version=1.2.0) ](https://bintray.com/ywl5320/maven/wlmusic/1.2.0/link)
